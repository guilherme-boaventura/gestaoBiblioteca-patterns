...
public class Biblioteca {
	...
	public void incluirMulta(Multa multa, String dataDevolucao) {
		   float valorMulta = multa.calcularMulta(dataDevolucao);
	        multa.setValor(valorMulta);
	        multas[quantidadeMultas] = multa;
	        quantidadeMultas++;
	}
